...
export function AppShell() {
  ...
  return (
    ...
    {toolsConfigOpen && (activeCwd ?? selectedSession?.cwd ?? newSessionCwd) && (
      <ToolsConfig cwd={(activeCwd ?? selectedSession?.cwd ?? newSessionCwd)!} onClose={() => setToolsConfigOpen(false)} />
    )}
    </>
  );
}
